...
namespace easyar
{
    ...
    public class ImageTrackerFrameFilter : FrameFilter, FrameFilter.IFeedbackFrameSink, FrameFilter.IOutputFrameSource
    {
        ...
        protected virtual void OnDisable()
        {
            ...
            {
                Tracker.stop();
                //Debug.Log("OnDisable set inactive from Image TrackerFrameFilter"); sigh, this wasn't it either
            }
        }
        ...
        public void UnloadTarget(ImageTargetController target)
        {
            ...
            target.Tracker = null;
            Debug.Log("UnloadTarget set inactive from Image TrackerFrameFilter");
        }
        ...
        internal void UnloadImageTarget(ImageTargetController controller, Action<Target, bool> callback)
        {
            ...
            Debug.Log("UnloadImageTarget set inactive from Image TrackerFrameFilter");
            }
        }
